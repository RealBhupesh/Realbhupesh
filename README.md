...
I solve problems through code, from autonomous community agents to numerical
fluid-flow experiments and full-stack products.

Currently building **Physicore**, exploring physics-controlled neural networks,
and giving software agents useful work to do.
...
- **Going deeper on simulation** - numerical methods, differentiable physics, CFD, and visualization
- **Shipping across the stack** - Python services, TypeScript products, Cloudflare systems, and Android apps
...
[![GitHub](https://img.shields.io/badge/-Follow_on_GitHub-181717?style=flat-square&logo=github&logoColor=white)](https://github.com/RealBhupesh)
